...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const addSkillForm = document.querySelector('.add-skill-form form');
    if (addSkillForm) {
        addSkillForm.addEventListener('submit', function (e) {
            ...
            const skillData = {
                ...
                time: formData.get('skillTime')
            };

            // Show success message
            alert('Skill added successfully! Thank you for contributing to SkillSwap.');
